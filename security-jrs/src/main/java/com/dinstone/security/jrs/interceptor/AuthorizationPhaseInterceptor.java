 ...
 * @version 1.0.0
 */
public class AuthorizationPhaseInterceptor extends AbstractPhaseInterceptor<Message> {

    private static final Logger LOG = LoggerFactory.getLogger(AuthorizationPhaseInterceptor.class);
    ...
    public AuthorizationPhaseInterceptor() {
        super(Phase.RECEIVE);
    }
    ...
    public void handleMessage(Message message) throws Fault {
        ...
        LOG.info("Authorization intercept a request operation[{}]", operation);
